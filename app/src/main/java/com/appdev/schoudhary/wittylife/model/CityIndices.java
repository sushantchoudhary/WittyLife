...
@Entity(tableName = "city_indices")
public class CityIndices implements Parcelable
{
    ...
    public final static Parcelable.Creator<CityIndices> CREATOR = new Creator<CityIndices>() {
        ...
        public CityIndices[] newArray(int size) {
            return (new CityIndices[size]);
        }

    }
            ;

    protected CityIndices(Parcel in) {
